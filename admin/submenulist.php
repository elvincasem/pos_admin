...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style="color:#000;"><i class="fa fa-list-ul fa-1x"></i> SUB-MENU LIST
						<div class="pull-right">
                                <div class="btn-group">
                                    <button id="additembutton" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#additem">
									<i class="fa fa-plus-circle"></i> Add Sub-Item
								</button>
                                </div>
                            </div></h1>
                </div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel">Add Sub-Item</h4>
							</div>
						...
						<form role="form" id="form_item"> 
							<div class="form-group">
								...
								<label>Affected Inventory</label>
								<select class="form-control" style="margin-bottom: 10px;">
									<option>Restaurant Inventory</option>
									<option>Sub-Menu Inventory</option>
									<option>Wind Meal</option>
								</select>
							</div>
